  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 z-10 w-full">
        <div className="sm:flex items-center justify-center gap-[10px] mb-[10px] w-full space-y-6 sm:space-y-0">
          {/* Female Option */}
          <div
            className={`bg-[#FFFFFFCC] sm:w-[179px] h-[125px] shadow-[0px_5px_20px_0px_#00000026] rounded-3xl flex items-center
